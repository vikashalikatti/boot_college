...
<body>
	...
	if (session.getAttribute("student") != null) {
		...
		BitMatrix bitMatrix = qrCodeWriter.encode(student.getName() + student.getDob(), BarcodeFormat.QR_CODE, 200, 200);
	...
	<div class="id-card-holder">
		<div class="id-card">
			...
			<div class="photo">
				<img
					src="data:image/jpeg;base64,<%=Base64.getEncoder().encodeToString(student.getPicture())%>">
			</div>
			<h2><%=student.getName()%></h2>
			<h3><%=student.getDob()%></h3>
			<h3><%=student.getCourse().getName()%></h3>
			<h3><%=student.getStream().getName()%></h3>
			<div class="qr-code">
	...
	%>
	<center>
	<a href="StudentHome.jsp"><button class="button">Back</button></a>
	</center>
</body>
</html>
