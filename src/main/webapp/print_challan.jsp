					...
					<div class="card-body p-0">
						...
						<div class="row pb-5 p-5">
							<div class="col-md-6">
								...
								<p class="mb-1"><%=student.getMobile()%></p>
							</div>
							...
							<div class="col-md-6 text-right">
								...
								<p class="mb-1">
									<span class="text-muted">VAT ID: </span>
									<%=new Random().nextInt(10000, 100000)%></p>
								<p class="mb-1">
									<span class="text-muted">Payment Type: </span> Offline/Bank
								</p>
								<p class="mb-1">
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th class="border-0 text-uppercase small font-weight-bold">Course
												Name</th>
											<th class="border-0 text-uppercase small font-weight-bold">Stream
												Name</th>
											<th class="border-0 text-uppercase small font-weight-bold">Course
												Fee</th>
											<th class="border-0 text-uppercase small font-weight-bold">Stream
